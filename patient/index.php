        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor">
                <a href="doctors.php" class="non-style-link-menu">
                    <div>
                        <p class="menu-text">All Veterinarian</p>
                </a>
    </div>
    </td>
    </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>Haven't any idea about Veterinarian? no problem let's jumping to
                                        <a href="doctors.php" class="non-style-link"><b>"All Veterinarian"</b></a>
                                        section or
                                        <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                        Track your past and future appointments history.<br>Also find out the expected
                                        arrival time of your Veterinarian or medical consultant.<br><br>
                                    </p>
