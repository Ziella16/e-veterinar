...
// Ambil data dari jadual users
$sql = "SELECT id, username, email, contact, pet_age, created_at FROM users";
$result = $conn->query($sql);

// Semak jika ada rekod dalam jadual
?>
                        ...
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" onclick="document.location='login.php'" class="btn btn-primary dropdown-toggle"data-bs-toggle="dropdown">
                                             <a href="login.php">Login</a>
                                             
                                             <button type="button" onclick="document.location='register.php'" class="btn btn-primary dropdown-toggle"data-bs-toggle="dropdown">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                ...
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".3s">Selamat Datang Ke Veterinar Parit Buntar</span>
                                    <h1 data-animation="fadeInUp" data-delay=".3s">Kami Menjaga Haiwan Kesayangan Anda.</h1>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                <!-- Video icon -->
                                <div class="video-icon">
                                    <a class="popup-video btn-icon" href="https://lh3.googleusercontent.com/ggs/AF1QipNXPaGAtFcerIfT_z_RrTC1QG2-vhbC1YjWCrJ4=m18" data-animation="bounceIn" data-delay=".4s">
                                        <i class="fas fa-play"></i>
                                    </a>
                                </div>
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".3s">Selamat Datang Ke Veterinar Parit Buntar</span>
                                    <h1 data-animation="fadeInUp" data-delay=".3s">Kami Merawat Haiwan Kesayangan Anda.</h1>
                                    <p data-animation="fadeInUp" data-delay=".6s">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna sectetur adipisci.</p>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                        ...
                                        <li>Email: <a href="mailto:vetcare@gmail.com" style="color: #1976D2;">veterinar@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>ABOUT US</h4>
                                <ul>
                                    <li><p>Menyediakan Perkhidmatan Veterinar Yang Berkualiti Bagi  Menjamin Kepentingan Awam & Industri Haiwan Yang Mapan Demi Kesejahteraan Manusia.</p></li>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://www.facebook.com/sai4ull" style="color: #1976D2;">Facebook</a> <a href="https://www.facebook.com/sai4ull"><i class="fab fa-facebook-square"></i></a></li>
                         ...
                         <div class="col-xl-12 ">
                             <div class="footer-copy-right text-center">
                                 <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                    © 2024 Copyright &copy;<script>document.write(new Date().getFullYear());</script> : e-veterinar.com <i class="fa fa-heart" aria-hidden="true"></i></a>
