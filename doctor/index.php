                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>Thanks for joinnig with us. We are always trying to get you a complete
                                        service<br>
                                        You can view your dailly schedule, Reach Animal Patients Appointment at
                                        home!<br><br>
                                    </p>
                                        ...
                                        <div class="dashboard-items"
                                            ...
                                            <div>
                                                <div class="h1-dashboard">
                                                    ...
                                                    $query =
                                                        "SELECT COUNT(*) as total FROM appointment_list WHERE status='0'  AND date=NOW()";
                        ...
                        <div class="abc scroll" style="height: 250px;padding: 0;margin: 0;">
                            <table width="85%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    $sqlmain = "SELECT *, DATE_FORMAT(time_start, '%H:%i') AS formatted_time FROM appointment_list
                                                    WHERE (date >= CURDATE() - INTERVAL WEEKDAY(CURDATE()) DAY
                                                    AND date < CURDATE() + INTERVAL (6 - WEEKDAY(CURDATE())) DAY) AND doc_id ='$userid' AND status='0' ";
